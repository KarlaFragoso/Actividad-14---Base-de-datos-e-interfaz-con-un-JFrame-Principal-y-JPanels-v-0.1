...
public class ModelAgenda {
    ...
    public void conectarDB() {
        try {
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3307/ejemplo_mvc","root","");
    ...
    /**Faltan comentarios**/
     public void insertarRegistro(){
        ...
        try {
           st.executeUpdate("Insert into usuarios (nombre,email,telefono)"+" values ('"+nombre +"','"+ email +"','"+ telefono +"');");
     ...
     public void modificarRegistro(){
        ...
        try {
           st.executeUpdate("UPDATE usuarios SET email ='"+ email +"',telefono = '"+ telefono +"'  WHERE nombre= '"+ nombre +"';");
